...
//		dao.setDataSource(dataSource);
		...
		this.user1 = new User("zz1", "김덕배", "duckbae11", Level.BASIC, 1, 0);
		this.user2 = new User("zz2", "창김화", "kim123", Level.SILVER, 55, 10);
		this.user3 = new User("zz3", "송아담", "song344", Level.GOLD, 100, 40);
	}
